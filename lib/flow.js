...
export const GROUPS = [
    {
        key: "car",
        title: "Milyen autó?",
        why: "Ha valami nincs a listában, írd be kézzel - úgy is működik.",
        submit: "Tovább",
    ...
    },
    {
        key: "detail",
        title: "A munkáról",
        why: "Válassz mindegyiknél. Ebből áll össze, milyen tételek és hány munkaóra kerül az ajánlatra.",
        submit: "Tovább a tételekhez",
...
export const FIELDS = {
    ...
    jobs: {
        ...
        hint: "Ami nincs a listában: **Egyéb munka** - ott magad írod be.",
    ...
    engine: {
        ...
        hint: "Ebből jön a normaidő és az olajmennyiség.",
        options: (sel) => {
    ...
    vin: {
        type: "vin",
        short: "Alvázszám",
        q: "Alvázszám (nem kötelező)",
        hint: "Rákerül az ajánlatra, hogy rendelésnél kéznél legyen. Írd be a 17 karaktert, vagy válassz lent.",
        options: [
    ...
    fek_kezifek: {
        ...
        hint: "Ha igen, a teszteres visszaállítás munkaideje is rákerül.",
    ...
    egyeb_munka: {
        ...
        short: "Egyéb munka",
        q: "Mi az a munka?",
        hint: "Így fog szerepelni az ajánlaton. Az óraszámot és az alkatrészt a következő lépésben adod meg.",
    ...
    parts_tier: {
        ...
        hint: "Ebből jön az alkatrészár. A következő lépésben soronként átírhatod.",
        options: [
