...
export const MAKES = [
    { name: "Opel", class: "kozep", models: [
        ...
        m("Astra", "kozep", ["1.2 benzin", "1.4 benzin", "1.4 Turbo benzin", "1.6 benzin", "1.8 benzin", "1.3 CDTI dízel", "1.6 CDTI dízel", "1.7 CDTI dízel", "1.9 CDTI dízel", "2.0 CDTI dízel"]),
        m("Insignia", "felso", ["1.6 Turbo benzin", "2.0 Turbo benzin", "2.0 CDTI dízel"]),
        m("Zafira", "kozep", ["1.6 benzin", "1.8 benzin", "2.2 benzin", "1.6 CDTI dízel", "1.7 CDTI dízel", "1.9 CDTI dízel", "2.0 CDTI dízel"]),
    ...
    { name: "Volkswagen", class: "kozep", models: [
        ...
        m("Golf", "kozep", ["1.2 TSI benzin", "1.4 benzin", "1.4 TSI benzin", "1.6 benzin", "2.0 TSI benzin", "1.6 TDI dízel", "1.9 TDI dízel", "2.0 TDI dízel"]),
        m("Passat", "kozep", ["1.6 benzin", "1.4 TSI benzin", "1.8 TSI benzin", "2.0 TSI benzin", "1.6 TDI dízel", "1.9 TDI dízel", "2.0 TDI dízel"]),
        m("Touran", "kozep", ["1.6 benzin", "1.4 TSI benzin", "2.0 benzin", "1.6 TDI dízel", "1.9 TDI dízel", "2.0 TDI dízel"]),
        m("Tiguan", "terepjaro", ["1.4 TSI benzin", "2.0 TDI dízel", "2.0 TSI benzin"]),
        m("Caddy", "kozep", ["1.4 benzin", "1.6 benzin", "1.2 TSI benzin", "1.9 TDI dízel", "1.6 TDI dízel", "2.0 TDI dízel"]),
    ...
    { name: "Škoda", class: "kozep", models: [
        ...
        m("Octavia", "kozep", ["1.2 TSI benzin", "1.4 TSI benzin", "1.6 benzin", "1.8 TSI benzin", "2.0 TSI benzin", "1.6 TDI dízel", "1.9 TDI dízel", "2.0 TDI dízel"]),
    ...
    { name: "Ford", class: "kozep", models: [
        ...
        m("Focus", "kozep", ["1.0 EcoBoost benzin", "1.4 benzin", "1.6 benzin", "1.8 benzin", "2.0 benzin", "1.6 TDCi dízel", "1.8 TDCi dízel", "2.0 TDCi dízel"]),
    ...
    { name: "Alfa Romeo", class: "felso", models: [
        m("147", "kozep", ["1.6 benzin", "1.9 JTD dízel"]),
        m("156", "kozep", ["1.8 benzin", "1.9 JTD dízel", "2.4 JTD dízel"]),
        m("159", "felso", ["1.9 JTD dízel", "2.0 JTD dízel", "2.4 JTD dízel"]),
        m("Giulietta", "kozep", ["1.4 TB benzin", "1.6 JTDm dízel", "2.0 JTDm dízel"]),
    ]},
    { name: "Chevrolet", class: "kis", models: [
        m("Aveo", "kis", ["1.2 benzin", "1.4 benzin", "1.3 CDTI dízel"]),
        m("Cruze", "kozep", ["1.6 benzin", "1.8 benzin", "2.0 CDTI dízel"]),
    ...
    { name: "Mini", class: "kozep", models: [
        m("One", "kis", ["1.4 benzin", "1.6 benzin"]),
        m("Cooper", "kis", ["1.6 benzin", "1.6 Turbo benzin", "1.6 D dízel", "2.0 D dízel"]),
        m("Countryman", "terepjaro", ["1.6 benzin", "2.0 D dízel"]),
    ]},
    { name: "Land Rover", class: "terepjaro", models: [
        m("Freelander", "terepjaro", ["2.0 benzin", "2.0 TD4 dízel", "2.2 TD4 dízel"]),
        m("Discovery", "terepjaro", ["2.7 TDV6 dízel", "3.0 TDV6 dízel"]),
        m("Range Rover Evoque", "terepjaro", ["2.0 benzin", "2.2 eD4 dízel"]),
    ]},
    { name: "Jeep", class: "terepjaro", models: [
        m("Compass", "terepjaro", ["1.4 benzin", "2.0 CRD dízel"]),
        m("Grand Cherokee", "terepjaro", ["3.0 CRD dízel", "3.6 benzin"]),
        m("Renegade", "terepjaro", ["1.4 benzin", "1.6 MultiJet dízel", "2.0 MultiJet dízel"]),
    ]},
    { name: "Lexus", class: "felso", models: [
        m("IS", "felso", ["2.0 benzin", "2.2 D dízel", "300h hibrid"]),
        m("RX", "terepjaro", ["3.5 benzin", "450h hibrid"]),
        m("CT", "kozep", ["200h hibrid"]),
    ]},
    { name: "Porsche", class: "felso", models: [
        m("Cayenne", "terepjaro", ["3.0 TDI dízel", "3.6 benzin"]),
        m("Macan", "terepjaro", ["2.0 benzin", "3.0 TDI dízel"]),
        m("Panamera", "felso", ["3.0 TDI dízel", "3.6 benzin"]),
    ]},
    { name: "Smart", class: "kis", models: [
        m("Fortwo", "kis", ["1.0 benzin", "0.8 CDI dízel"]),
        m("Forfour", "kis", ["1.0 benzin", "1.5 CDI dízel"]),
    ]},
    { name: "Subaru", class: "terepjaro", models: [
        m("Forester", "terepjaro", ["2.0 benzin", "2.0 D dízel", "2.5 benzin"]),
        m("Impreza", "kozep", ["1.5 benzin", "2.0 benzin", "2.0 D dízel"]),
        m("Outback", "terepjaro", ["2.0 D dízel", "2.5 benzin"]),
    ]},
    { name: "SsangYong", class: "terepjaro", models: [
        m("Korando", "terepjaro", ["2.0 e-XDi dízel", "2.2 e-XDi dízel"]),
        m("Rexton", "terepjaro", ["2.7 XDi dízel", "2.2 e-XDi dízel"]),
    ]},
    { name: "Saab", class: "felso", models: [
        m("9-3", "felso", ["1.8 benzin", "1.9 TiD dízel", "2.0 Turbo benzin"]),
        m("9-5", "felso", ["2.0 Turbo benzin", "1.9 TiD dízel"]),
    ]},
    { name: "Lancia", class: "kozep", models: [
        m("Ypsilon", "kis", ["1.2 benzin", "1.3 JTD dízel"]),
        m("Delta", "kozep", ["1.4 benzin", "1.6 JTD dízel"]),
    ]},
    { name: "Daewoo", class: "kis", models: [
        m("Matiz", "kis", ["0.8 benzin", "1.0 benzin"]),
        m("Lanos", "kis", ["1.4 benzin", "1.5 benzin"]),
        m("Nubira", "kozep", ["1.6 benzin", "2.0 benzin"]),
    ]},
    { name: "Cupra", class: "kozep", models: [
        m("Formentor", "terepjaro", ["1.5 TSI benzin", "2.0 TSI benzin", "2.0 TDI dízel"]),
        m("Leon", "kozep", ["1.5 TSI benzin", "2.0 TSI benzin", "2.0 TDI dízel"]),
    ]},
